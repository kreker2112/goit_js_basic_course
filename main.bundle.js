    ...
    return indexAsync_regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("178392604_0", "currentHits: ", currentHits)));

          // Запись общего количества найденных изображений в переменную:
          totalHits = imagesResponse.data.totalHits;
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("178392604_1", "totalHits: ", totalHits)));

          // Запись массива изображений из ответа от сервера в переменную:
          imagesArr = imagesResponse.data.hits;
          /* eslint-disable */
          (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("178392604_2", "imagesArr: ", imagesArr)));
          ...
          try {
            ...
            /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("178392604_3", error)));
          }
        case 16:
        case "end":
          return _context.stop();
    ...
    return indexAsync_regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          imagesArr = imagesResponse.data.hits;
          /* eslint-disable */
          (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("178392604_4", "currentHits after LoadMore: ", currentHits * pageNumber)));

          // Запись количества найденных изображений в переменную:
          totalHits = imagesResponse.data.totalHits;
          /* eslint-disable */
          (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("178392604_5", "totalHits after LoadMore: ", totalHits)));
          try {
            // Проверка на наличие совпадений:
            ...
            /* eslint-disable */(_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("178392604_6", error)));
          }
        case 9:
        case "end":

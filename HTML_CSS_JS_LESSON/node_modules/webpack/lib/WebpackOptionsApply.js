...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\KREkER\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.357\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '201bbbf7e7b1de9431c3e0BExbU0gHX1JQAAIGX1ILAlILBlVQ', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/KREkER/.vscode/extensions/wallabyjs.console-ninja-1.0.357/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '201bbbf7e7b1de9431c3e0BExbU0gHX1JQAAIGX1ILAlILBlVQ', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

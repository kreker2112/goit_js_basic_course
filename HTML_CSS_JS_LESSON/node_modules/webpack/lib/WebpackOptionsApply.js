...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\KREkER\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.355\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20493050cd13eacfd9196aARcKARsAWQECBQNWWwBQAARYUAMB'}); } catch(cjsError) { try { import('file:///c:/Users/KREkER/.vscode/extensions/wallabyjs.console-ninja-1.0.355/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20493050cd13eacfd9196aARcKARsAWQECBQNWWwBQAARYUAMB'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

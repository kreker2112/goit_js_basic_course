...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\KREkER\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.358\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20ae96fe0cfc533e04a5fcVEsAB0hVCgZQVwJXClZVA1UNBFVV', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/KREkER/.vscode/extensions/wallabyjs.console-ninja-1.0.358/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20ae96fe0cfc533e04a5fcVEsAB0hVCgZQVwJXClZVA1UNBFVV', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

...
// Напиши функцию isLoginValid(login), в которой проверь количество символов параметра login и верни true или false в
// зависимости от того, попадает ли длина параметра в заданный диапазон от 4-х до 16-ти символов включительно.
...
const loginIsInvalidMessage = "Ошибка! Логин должен быть от 4 до 16 символов";

const loginIsNotUniqueMessage = "Такой логин уже используется!";

const loginSuccessMessage = "Логин успешно добавлен!";

const isLoginValid = function (login) {
  const loginIsValid = login.length >= 4 && login.length <= 16;
  if (loginIsValid === false) {
    alert(loginIsInvalidMessage);
...
const isLoginUnique = function (allLogins, login) {
  ...
  for (let oneLogin of allLogins) {
    loginIsUnique = !allLogins.includes(login);
    console.log("loginIsUnique: ", loginIsUnique);
    if (loginIsUnique === false) {
      alert(loginIsNotUniqueMessage);
      break;
    }
  }
};
